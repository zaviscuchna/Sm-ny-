...
const CONFIG: Record<ShiftStatus, { label: string; className: string }> = {
  ...
  planned:   { label: 'Naplánováno', className: 'bg-slate-50 text-slate-600 border-slate-200' },
  completed: { label: 'Splněno',     className: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
  cancelled: { label: 'Zrušeno',     className: 'bg-slate-50 text-slate-400 border-slate-200' },
}
