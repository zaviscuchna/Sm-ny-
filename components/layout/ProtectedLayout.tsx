...
const MANAGER_ROUTES   = ['/dashboard', '/shifts', '/employees', '/open-shifts', '/settings', '/qr', '/history', '/payroll', '/my-shifts']
const EMPLOYEE_ROUTES  = ['/my-shifts', '/shifts', '/open-shifts', '/settings', '/history', '/payroll']
